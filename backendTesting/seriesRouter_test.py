...
def test_get_all_series_success():
    mock_data = {
...
def test_get_series_movies_success():
    expected = [
...
def test_get_series_movies_not_found():
...
def test_create_series_success(mock_admin_user):
...
def test_create_series_unauthenticated(mock_invalid_session):
    movies = [("Iron Man", 1)]
    response = client.post(
        "/create",
...
def test_create_series_forbidden_for_non_admin(mock_normal_user):
    movies = [("Iron Man", 1)]
    response = client.post(
        "/create",
...
def test_create_series_invalid_orders(mock_admin_user):
...
def test_update_series_success(mock_admin_user):
...
def test_update_series_not_admin(mock_normal_user):
    movies = [("Iron Man", 1)]
    response = client.put(
        "/update/Marvel",
...
def test_update_series_invalid_orders(mock_admin_user):
...
# delete test
def test_delete_series_success(mock_admin_user):
...
def test_delete_series_forbidden(mock_normal_user):
    response = client.delete(
        "/Marvel",
        params={"sessionToken": "regular"}
    )
...
def test_delete_series_unauthenticated(mock_invalid_session):
    response = client.delete(
        "/Marvel",
